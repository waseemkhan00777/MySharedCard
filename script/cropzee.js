        ...
        function cropzeeTriggerModal(id, src) {
            ...
            '<div class="light-modal" id="cropzee-modal" role="dialog" aria-labelledby="light-modal-label" aria-hidden="false" data-lightmodal="close">'
                + '<div class="light-modal-content ' + animation + '">'
                    ...
                    + '</div> -->'
                    + '<!-- light modal body -->'
                    + '<div class="light-modal-body" style="max-height: 500px; background:rgb(0,173,238);">'
                        + '<img id="cropzee-modal-image" src="' + src + '">'
                    + '</div>'
                    + '<!-- light modal footer -->'
                    + '<div class="light-modal-footer" style="justify-content: space-between; background:rgb(0,173,238);">'
                        + '<div onclick="closeModal()" class="light-modal-close-btn" style="cursor: pointer; background:rgb(153,239,246); color:black;" aria-label="close">Cancel</div>'
                        + '<div onclick="cropzeeRotateImage(`' + id + '`);" class="light-modal-close-btn" style="cursor: pointer;  background:rgb(153,239,246); color:black;">Rotate</div>'
                        + '<div onclick="cropzeeCreateImage(`' + id + '`);" class="light-modal-close-btn" style="cursor: pointer;  background:rgb(153,239,246); color:black;">Done</div>'
                    + '</div>'
                + '</div>'
